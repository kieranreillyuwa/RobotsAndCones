...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_high_speed_encoder_SOURCE_PREFIX /home/netipc/RobotsAndCones/catkin_ws/src/phidgets_drivers/phidgets_high_speed_encoder)
  set(phidgets_high_speed_encoder_DEVEL_PREFIX /home/netipc/RobotsAndCones/catkin_ws/devel)
  ...
  set(phidgets_high_speed_encoder_INSTALL_PREFIX /home/netipc/RobotsAndCones/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_high_speed_encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/netipc/RobotsAndCones/catkin_ws/src/phidgets_drivers/phidgets_high_speed_encoder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT phidgets_high_speed_encoder_NUM_DUMMY_TARGETS)
      set(phidgets_high_speed_encoder_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::phidgets_high_speed_encoder::wrapped-linker-option${phidgets_high_speed_encoder_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR phidgets_high_speed_encoder_NUM_DUMMY_TARGETS "${phidgets_high_speed_encoder_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::phidgets_high_speed_encoder::wrapped-linker-option${phidgets_high_speed_encoder_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND phidgets_high_speed_encoder_LIBRARIES "${interface_target_name}")
...
set(depends "nodelet;phidgets_api;phidgets_msgs;pluginlib;roscpp;sensor_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(phidgets_high_speed_encoder_EXPORTED_TARGETS ${${phidgets_high_speed_encoder_dep}_EXPORTED_TARGETS})
endforeach()
